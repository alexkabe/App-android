CREATE TABLE IF NOT EXISTS client(id integer auto_increment primary key, code text, nom text, prenom text, psa int(8));
...
CREATE TABLE IF NOT EXISTS article(id integer auto_increment primary key, code text, prix int(16), quantite int(16), noma text);
